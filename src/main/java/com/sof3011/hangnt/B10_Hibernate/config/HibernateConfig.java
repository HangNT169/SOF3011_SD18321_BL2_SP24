package com.sof3011.hangnt.B10_Hibernate.config;
...
public class HibernateConfig {
    ...
    static {
        ...
        conf.addAnnotatedClass(Category1.class); // Dk vs hibernate day la doi tuong thuc the co the truy van va mapper
